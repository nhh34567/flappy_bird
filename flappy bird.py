...
def draw_floor():
    ...
    screen.blit(floor,(floor_x_pos+400,500))
def create_pipe():
    random_pipe_pos = random.choice(pipe_height)
    bottom_pipe = pipe_surface.get_rect(midtop = (400,random_pipe_pos))
    top_pipe = pipe_surface.get_rect(midtop = (400,random_pipe_pos-600))
...
def score_display(game_state):
    ...
    if game_state == 'game over':
        ...
        high_score_rect = high_score_surface.get_rect(center = (200,450))
...
floor = pygame.transform.scale(floor,(400,100))
floor_x_pos = 0
#tao chim
bird = pygame.image.load('assets/yellowbird-midflap.png').convert_alpha()
bird = pygame.transform.scale(bird,(40,33))
bird_rect = bird.get_rect(center = (90,250))
#tao ong
pipe_surface = pygame.image.load('assets/pipe-green.png').convert()
pipe_surface = pygame.transform.scale(pipe_surface,(80,500))
pipe_list = []
spawnpipe = pygame.USEREVENT
pygame.time.set_timer(spawnpipe , 1200)
pipe_height = [200, 280, 370]
